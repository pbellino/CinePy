...
from modules.point_kinetics.reactimetro_python import reactimetro_python
...
if __name__ == "__main__":
    ...
    rho_r, t_r, _ = reactimetro_python(n, t, lam, b, Lambda_red)
    rho_c, t_c, _ = reactimetro(n, dt, lam, b, Lambda_red)

    #print(f"Coinciden ambos reactimetros: {np.allclose(rho_r, rho_c, atol=1e-16)}")
