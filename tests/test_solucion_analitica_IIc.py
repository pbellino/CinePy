...
from modules.point_kinetics.soluciones_analiticas import solucion_analitica_IIc
...
if __name__ == "__main__":
    ...
    n_analitica = solucion_analitica_IIc(t, t0, rho_i, Q_f, constants)
    ...
    ax[0].plot(t, n_analitica, 'o', label='analítica_IIc')
