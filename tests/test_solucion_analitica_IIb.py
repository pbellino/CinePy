...
from modules.point_kinetics.soluciones_analiticas import solucion_analitica_IIb
...
if __name__ == "__main__":
    ...
    n_analitica = solucion_analitica_IIb(t, t0, rho_i, Q_i, constants)
    ...
    ax[0].plot(t, n_analitica, 'o', label='analítica_IIb')
